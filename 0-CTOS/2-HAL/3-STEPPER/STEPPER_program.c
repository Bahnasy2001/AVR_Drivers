...
// Step Angle = 0.5 deg so No of steps for full step = 360/0.5 = 720
	...
	if(direction == STEPPER_u8_CCW)
	{
		for(i = 0; i < Local_u8NoOfiterations;i++)
		{
			...
			DIO_u8SetPinValue(STEPPER_u8_PORT,STEPPER_u8_PIN0,DIO_u8_HIGH);
			DIO_u8SetPinValue(STEPPER_u8_PORT,STEPPER_u8_PIN1,DIO_u8_HIGH);
			DIO_u8SetPinValue(STEPPER_u8_PORT,STEPPER_u8_PIN2,DIO_u8_LOW);
			DIO_u8SetPinValue(STEPPER_u8_PORT,STEPPER_u8_PIN3,DIO_u8_LOW);
			_delay_ms(100);
			//Step 2 0x06 --> - step angle * 2
			DIO_u8SetPinValue(STEPPER_u8_PORT,STEPPER_u8_PIN0,DIO_u8_LOW);
			DIO_u8SetPinValue(STEPPER_u8_PORT,STEPPER_u8_PIN1,DIO_u8_HIGH);
			DIO_u8SetPinValue(STEPPER_u8_PORT,STEPPER_u8_PIN2,DIO_u8_HIGH);
			DIO_u8SetPinValue(STEPPER_u8_PORT,STEPPER_u8_PIN3,DIO_u8_LOW);
			_delay_ms(100);
			//Step 1 0x0C --> - step angle * 3
			DIO_u8SetPinValue(STEPPER_u8_PORT,STEPPER_u8_PIN0,DIO_u8_LOW);
			DIO_u8SetPinValue(STEPPER_u8_PORT,STEPPER_u8_PIN1,DIO_u8_LOW);
			DIO_u8SetPinValue(STEPPER_u8_PORT,STEPPER_u8_PIN2,DIO_u8_HIGH);
			DIO_u8SetPinValue(STEPPER_u8_PORT,STEPPER_u8_PIN3,DIO_u8_HIGH);
			_delay_ms(100);
